...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await signInWithEmailAndPassword(auth, emailInp, passwordInp);
      console.log("Logged in successfully!");
      setEmailInp("");
      setPasswordInp("");
      // Success hone par chat / dashboard route par bhej dein:
      // navigate('/chat');
    } catch (err) {
  ...
  const googleBtn = async () => {
    ...
    try {
      ...
      // Check karein agar bilkul naya user Google se Sign in kar raha hai
