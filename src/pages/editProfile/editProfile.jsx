                ...
                <div className="edit-profile-container">
                    ...
                    <section className="edit-profile-section">
                        ...
                        <div className="profile-setting-card">
                            ...
                            <Link to="/settings/editprofile/editprofileimage" className="profile-setting-row">
                                ...
                                <button className="profile-setting-row">
                                    ...
                                    <span className="profile-setting-icon image-icon">
                                        <svg viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                                d="M19 3H5C3.9 3 3 3.9 3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 3.5A2.5 2.5 0 1110 11a2.5 2.5 0 010-4.5zM5 19l3.5-4.5 2.5 3 3.5-4.5L19 19H5z"
                                            />
                                        </svg>
                                    </span>
                        ...
                        <div className="profile-setting-card">
                            ...
                            <button className="profile-setting-row">
                                ...
                                <span className="profile-setting-icon bio-icon">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            d="M4 4h16v2H4V4zm0 5h16v2H4V9zm0 5h11v2H4v-2zm0 5h8v2H4v-2z"
                                        />
                                    </svg>
                                </span>
